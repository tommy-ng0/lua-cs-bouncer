...
{
        cs = require "crowdsec"
        local ok, err = cs.init("./t/conf_t/10_live_crowdsec_nginx_bouncer.conf", "crowdsec-nginx-bouncer/v1.0.8")
        if ok == nil then
...
location = /t {
    ...
    log_by_lua_block {
        ...
        local ignored_keys = { "last_refresh", "metrics_startup_time", "metrics_data" }
