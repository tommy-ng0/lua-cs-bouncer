...
{
        cs = require "crowdsec"
        local ok, err = cs.init("./t/conf_t/13_stream_crowdsec_nginx_bouncer.conf", "crowdsec-nginx-bouncer/v1.0.8")
        if ok == nil then
    ...
    listen 8081;
      ...
      location = /v1/decisions/stream {
            ...
            if args.startup == "true" then
               ...
               ngx.say('{"deleted": [{"duration":"1h00m00s","id":4091593,"origin":"CAPI","scenario":"crowdsecurity/vpatch-CVE-2024-4577","scope":"Ip","type":"captcha","value":"1.1.1.1"}], "new": [{"duration":"1h00m00s","id":4091593,"origin":"CAPI","scenario":"crowdsecurity/vpatch-CVE-2024-4577","scope":"Ip","type":"ban","value":"1.1.1.2"}]}')
            end
            }
      }
}
